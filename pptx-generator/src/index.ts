...
import { PACKAGE_ROOT, getVersion } from './version.js';
  ...
  try {
    if (existsSync(sidecar)) {
      ...
      if (sidecarMtime >= pptxMtime) {
        ...
        const cached = TemplateCapabilitiesSchema.parse(JSON.parse(raw));

        // Invalidate sidecar if generated by a different validator version
        if (cached.validator_version !== getVersion()) {
